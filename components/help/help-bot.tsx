...
const BOT_LABELS: Record<string, { title: string; subtitle: string; welcome: string; placeholder: string; related: string; popular: string; error: string }> = {
  he: { title: "בוט עזרה", subtitle: "תמיד כאן לעזור", welcome: "שלום! אני בוט העזרה של PMO++. אני יכול לענות על כל שאלה על השימוש במערכת.", placeholder: "שאל אותי משהו...", related: "אולי גם תרצה לדעת", popular: "שאלות נפוצות", error: "מצטער, נתקלתי בשגיאה. נסה לנסח את השאלה אחרת." },
  en: { title: "Help Bot", subtitle: "Always here to help", welcome: "Hi! I'm the PMO++ help bot. I can answer any question about how to use the system.", placeholder: "Ask me anything...", related: "You might also want", popular: "Quick questions", error: "Sorry, I encountered an error. Try rephrasing." },
  ru: { title: "Бот помощи", subtitle: "Всегда готов помочь", welcome: "Привет! Я бот помощи PMO++. Могу ответить на любой вопрос о системе.", placeholder: "Спросите меня...", related: "Возможно, вас заинтересует", popular: "Популярные вопросы", error: "Извините, произошла ошибка. Попробуйте переформулировать." },
  fr: { title: "Bot d'aide", subtitle: "Toujours là pour aider", welcome: "Bonjour ! Je suis le bot d'aide PMO++. Je peux répondre à toute question sur le système.", placeholder: "Posez votre question...", related: "Vous pourriez aussi vouloir", popular: "Questions fréquentes", error: "Désolé, une erreur est survenue. Essayez de reformuler." },
  es: { title: "Bot de ayuda", subtitle: "Siempre aquí para ayudar", welcome: "¡Hola! Soy el bot de ayuda de PMO++. Puedo responder cualquier pregunta sobre el sistema.", placeholder: "Pregúntame algo...", related: "También podría interesarte", popular: "Preguntas frecuentes", error: "Lo siento, ocurrió un error. Intenta reformular." },
};

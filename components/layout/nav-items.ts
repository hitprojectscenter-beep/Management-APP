...
export const NAV_GROUP_OF: Record<string, NavGroupKey> = {
  ...
  calendar: "calendar",
  dashboard: "management", intake: "management", reports: "management", analytics: "management", team: "management",
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: "analytics",   icon: PieChart,            href: "/analytics",     labels: { he: "דוחות ואנליטיקה",    en: "Analytics",         ru: "Аналитика",           fr: "Analytique",           es: "Analítica"         }, tooltips: { he: "בונה דוחות לפי מאפיינים וטווח תאריכים, חיפוש חופשי, והתפלגויות לפי חטיבה / אגף / עובד (בהתאם להרשאות)", en: "Build reports by attribute & date range, free-text search, and division / department / employee distributions (permission-scoped)" } },
